...
const ShiftButton = ({
    ...
    return (
        ...
        >
            <div className="shift-button-bg absolute inset-0 rounded-full transition-transform duration-[600ms] bg-white shadow"></div>
            <span data-button-animate-chars="" className="shift-button-text relative text-sm inline-block overflow-hidden whitespace-nowrap">
                {text}
            </span>
