...
function GalleryBento({ items, className }: GalleryBentoProps) {
  const { 
    getLayoutClasses, 
  ...
  const renderGalleryGrid = useCallback((items: GalleryItemData[], startIndex: number = 0) => {
    ...
    return (
      <div className={getGridContainerClasses(itemCount)} style={dynamicStyles}>
  ...
  }, [getLayoutClasses, getGridContainerClasses, getImageDimensions, getGridStyles])
