...
const InfoRevealBentoItem = React.memo(forwardRef<HTMLDivElement, InfoRevealBentoItemProps>(({ item, index, isMobile = false, enableHoverAnimation = true, showImages = true, totalItems = 5 }, ref) => {
    ...
    const className = showImages ? baseClassName : `${baseClassName} bg-white shadow`
